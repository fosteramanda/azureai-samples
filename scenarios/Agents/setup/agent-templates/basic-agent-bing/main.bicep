...
param bingSearchName string = 'basic-project'
...
module aiDependencies 'modules-basic-bing/basic-dependent-resources.bicep' = {
...
module aiHub 'modules-basic-bing/basic-ai-hub-identity.bicep' = {
  ...
  params: {
    ...
    bingSearchName: aiDependencies.outputs.bingName
  }
}

module aiProject 'modules-basic-bing/basic-ai-project-identity.bicep' = {
...
module aiServiceRoleAssignments 'modules-basic-bing/ai-service-role-assignments.bicep' = {
